        ...
        try {
            ...
            if (!hasRequests) {
                ...
                for (const message of messages) {
                    await ((_c = this.onmessage) === null || _c === void 0 ? void 0 : _c.call(this, message, { authInfo, requestInfo }));
                }
            }
            else if (hasRequests) {
                ...
                // handle each message
                for (const message of messages) {
                    await ((_d = this.onmessage) === null || _d === void 0 ? void 0 : _d.call(this, message, { authInfo, requestInfo }));
                }
